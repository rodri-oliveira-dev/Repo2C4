...
```bash
dotnet pack src/Repo2C4/Repo2C4.csproj \
...
Before publishing a real package, replace the placeholder package metadata in `src/Repo2C4/Repo2C4.csproj`, especially `Authors` and `Description`.
